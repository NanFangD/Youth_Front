                        ...
                        params:{
                            ...
                            successResponse => {
                                if (successResponse.data !=="") {
                                    ...
                                    document.cookie="fang="+(successResponse.data*2+10)+";"+"expires="+d.toUTCString();
...
<style>
    #poster {
        background: url("../../../public/img/background/login.jpg") no-repeat center;
        height: 100%;
        width: 100%;
